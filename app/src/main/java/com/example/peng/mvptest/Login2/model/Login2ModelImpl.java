package com.example.peng.mvptest.Login2.model;


import com.example.peng.mvptest.Login2.presenter.Login2Presenter;
...
public class Login2ModelImpl implements Login2Model{
    ...
    @Override
    public void login(String name, String psw, Login2Presenter login2Presenter) {
